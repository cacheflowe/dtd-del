...
class App:
	...
	- This file is externalized to the `python/app` directory
	"""
	...
	def FixNetworkErrors(self):
		"""Launch a one-shot pi agent session (non-blocking) to find and fix the error in
		whatever network is currently open in the TD UI, via td_http_api.py + td-docs-mcp."""
		return harness_util.run_named_prompt('fix_network_errors')
